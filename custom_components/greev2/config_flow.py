...
class GreeV2ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        _LOGGER.debug("Config Flow: User step started (minimal registration).")
        ...
        if user_input is not None:
            ...
            _LOGGER.debug("Config Flow: User input received (placeholder).")
            ...
            return self.async_create_entry(title="Gree V2 Device", data={})
